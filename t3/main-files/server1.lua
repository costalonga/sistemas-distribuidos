...
local myobj = {
  ...
  execute = function (addresses_lst) -- TODO: FIX, change back 'addresses_lst' -> 'addresses'
    ...
    local heartbeat_timeout = 15 -- TODO: get a random valid time -- TODO começar testes com valores grandes
    ...
    while true do
      ...
      local rand_wait_time = 0.5 -- TODO: must be smaller than heartbets time
